...
Route::post('/admin/products/add-product/save-product', [App\Http\Controllers\AdminController::class, 'saveProduct'])->name('admin.saveProduct')->middleware('role:superadministrator');
...
Route::get('/admin/accounts/{$user}', [App\Http\Controllers\AdminController::class, 'editUser'])->name('admin.editUser')->middleware('role:superadministrator');
